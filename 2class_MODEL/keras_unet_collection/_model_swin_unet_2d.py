...
def swin_unet_2d(input_size=(512,512,3), filter_num_begin=128, n_labels=3, depth=4, stack_num_down=2, stack_num_up=2, 
                      patch_size=(4, 4), num_heads=[4, 8, 8, 8], window_size=[4, 2, 2, 2], num_mlp=512, output_activation='Softmax', shift_window=True, name='swin_unet'):
    '''
    The base of SwinUNET.
    ...
    # output layer
    OUT = CONV_output(X, n_labels, kernel_size=1, activation=output_activation, name='final_conv')
