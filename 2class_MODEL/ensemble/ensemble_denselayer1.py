# -*- coding: utf-8 -*-
"""
Created on Mon Jul 11 22:02:13 2022
...
test_path_image = "C:/Users/EN308/Desktop/Kai/2class_MODEL/yun_normal/test_CLAHEresult_image"

val_img1=getTestDate("C:/Users/EN308/Desktop/Kai/2class_MODEL/yun_normal/val/image")
train_img1=getTestDate("C:/Users/EN308/Desktop/Kai/2class_MODEL/yun_normal/train/image")
test_imag1=getTestDate("C:/Users/EN308/Desktop/Kai/2class_MODEL/yun_normal/test_Noneresult_image")
                ...
                for blackbone in range(len(blackbone_functions)):
                    ...
                    for loss in range(len(loss_functions_str)):
                        ...
                        for rate in range(len(rate_functions)):
                            ...
                            model.load_weights("C:/Users/EN308/Desktop/Kai/2class_MODEL/"+folder_functions[0]+'/model/'+filepath)
                            model1=model


#Set compile=False as we are not loading it for training, only for prediction.

#model2 = load_model('C:/Users/EN308/Desktop/Kai/2class_MODEL/yun_normal/model/model_att_unetplusplus_psp_yun_normal_CLAHE_0.0001_total_loss_resnet50.hdf5', compile=False)
val_img2=getTestDate("C:/Users/EN308/Desktop/Kai/2class_MODEL/yun_normal/val/image_CLAHE")
train_img2=getTestDate("C:/Users/EN308/Desktop/Kai/2class_MODEL/yun_normal/train/image_CLAHE")
test_imag2=getTestDate("C:/Users/EN308/Desktop/Kai/2class_MODEL/yun_normal/test_CLAHEresult_image")

# val_img2=getTestDate("C:/Users/EN308/Desktop/Kai/2class_MODEL/yun_normal/val/image")
# train_img2=getTestDate("C:/Users/EN308/Desktop/Kai/2class_MODEL/yun_normal/train/image")
# test_imag2=getTestDate("C:/Users/EN308/Desktop/Kai/2class_MODEL/yun_normal/test_Noneresult_image")
...
# model3 = load_model('C:/Users/EN308/Desktop/Kai/2class_MODEL/yun_normal/model/model_att_unet_yun_normal_CLAHE_0.0001_total_loss_resnet50.hdf5', compile=False)                            
val_img3=getTestDate("C:/Users/EN308/Desktop/Kai/2class_MODEL/yun_normal/val/image_CLAHE")
train_img3=getTestDate("C:/Users/EN308/Desktop/Kai/2class_MODEL/yun_normal/train/image_CLAHE")
test_imag3=getTestDate("C:/Users/EN308/Desktop/Kai/2class_MODEL/yun_normal/test_CLAHEresult_image")
...
# model4 = load_model('C:/Users/EN308/Desktop/Kai/2class_MODEL/yun_normal/model/model_att_unetplusplus_yun_normal_CLAHE_0.0001_total_loss_resnet50.hdf5', compile=False)                   
val_img4=getTestDate("C:/Users/EN308/Desktop/Kai/2class_MODEL/yun_normal/val/image_CLAHE")
train_img4=getTestDate("C:/Users/EN308/Desktop/Kai/2class_MODEL/yun_normal/train/image_CLAHE")
test_imag4=getTestDate("C:/Users/EN308/Desktop/Kai/2class_MODEL/yun_normal/test_CLAHEresult_image")

clip_functions=["CLAHE"]
blackbone_functions=['xception']
net_str=['Deeplabv3plus']
loss_functions_str =['total_loss']
rate_functions =[1e-04]
folder_functions=["yun_normal"]
for clahe in range(len(clip_functions)):
                    ...
                    for loss in range(len(loss_functions_str)):
                        ...
                        for rate in range(len(rate_functions)):
                            ...
                            if blackbone_functions[blackbone] == "none" :
                              ...
                              model =modelv3.Deeplabv3(input_shape = (512,512,3))
                            model_input = model.input
...
# val_img5=getTestDate("C:/Users/EN308/Desktop/Kai/2class_MODEL/yun_normal/val/image_CLAHE")
# train_img5=getTestDate("C:/Users/EN308/Desktop/Kai/2class_MODEL/yun_normal/train/image_CLAHE")
# test_imag5=getTestDate("C:/Users/EN308/Desktop/Kai/2class_MODEL/yun_normal/test_CLAHEresult_image")

val_img5=getTestDate("C:/Users/EN308/Desktop/Kai/2class_MODEL/yun_normal/val/image")
train_img5=getTestDate("C:/Users/EN308/Desktop/Kai/2class_MODEL/yun_normal/train/image")
test_imag5=getTestDate("C:/Users/EN308/Desktop/Kai/2class_MODEL/yun_normal/test_Noneresult_image")
...
label_train=getTestDate_label("C:/Users/EN308/Desktop/Kai/2class_MODEL/yun_normal/train/label") #引入訓練集
label_val=getTestDate_label("C:/Users/EN308/Desktop/Kai/2class_MODEL/yun_normal/val/label")
label=getTestDate_label("C:/Users/EN308/Desktop/Kai/2class_MODEL/yun_normal/test_label")
...
for index in range(236):
    train_img1_index=train_img1[index:index+1,:,:,:]
    train_img2_index=train_img2[index:index+1,:,:,:]
    train_img3_index=train_img3[index:index+1,:,:,:]
    train_img4_index=train_img4[index:index+1,:,:,:]
    train_img5_index=train_img5[index:index+1,:,:,:]
    # train_img6_index=train_img6[index:index+1,:,:,:]
    train_img1_index = np.array(train_img1_index)
    train_img2_index = np.array(train_img2_index)
    train_img3_index = np.array(train_img3_index)
    train_img4_index = np.array(train_img4_index)
    train_img5_index = np.array(train_img5_index)
    # train_img6_index = np.array(train_img6_index)
    
    pred1 = model1.predict(train_img1_index)
    reset_keras()
    pred2 = model2.predict(train_img2_index)
    reset_keras()
    pred3 = model3.predict(train_img3_index)
    reset_keras()
    pred4 = model4.predict(train_img4_index)
    reset_keras()
    pred5 = model5.predict(train_img5_index)
    reset_keras()
    # pred6 = model6.predict(train_img6_index)
    # reset_keras()
    train_pred1_add.append(np.array(pred1[0,:,:,:]))
    train_pred2_add.append(np.array(pred2[0,:,:,:]))
    train_pred3_add.append(np.array(pred3[0,:,:,:]))
    train_pred4_add.append(np.array(pred4[0,:,:,:]))
    train_pred5_add.append(np.array(pred5[0,:,:,:]))
    # train_pred6_add.append(np.array(pred6[0,:,:,:]))

#先分類後回歸
# train_pred1_add = np.argmax(np.array(train_pred1_add), axis=3)[:,:,:]
# train_pred2_add = np.argmax(np.array(train_pred2_add), axis=3)[:,:,:]
# train_pred3_add = np.argmax(np.array(train_pred3_add), axis=3)[:,:,:]
# train_pred4_add = np.argmax(np.array(train_pred4_add), axis=3)[:,:,:]
# train_pred5_add = np.argmax(np.array(train_pred5_add), axis=3)[:,:,:]
# train_pred6_add = np.argmax(np.array(train_pred6_add), axis=3)[:,:,:]
# train_pred1_add = train_pred1_add.reshape((train_pred1_add.shape[0], train_pred1_add.shape[1], train_pred1_add.shape[2], 1))
# train_pred2_add = train_pred2_add.reshape((train_pred2_add.shape[0], train_pred2_add.shape[1], train_pred2_add.shape[2], 1))
# train_pred3_add = train_pred3_add.reshape((train_pred3_add.shape[0], train_pred3_add.shape[1], train_pred3_add.shape[2], 1))
# train_pred4_add = train_pred4_add.reshape((train_pred4_add.shape[0], train_pred4_add.shape[1], train_pred4_add.shape[2], 1))
# train_pred5_add = train_pred5_add.reshape((train_pred5_add.shape[0], train_pred5_add.shape[1], train_pred5_add.shape[2], 1))
# train_pred6_add = train_pred6_add.reshape((train_pred6_add.shape[0], train_pred6_add.shape[1], train_pred6_add.shape[2], 1))

#驗證影像
for index in range(30):
    val_img1_index=val_img1[index:index+1,:,:,:]
    val_img2_index=val_img2[index:index+1,:,:,:]
    val_img3_index=val_img3[index:index+1,:,:,:]
    val_img4_index=val_img4[index:index+1,:,:,:]
    val_img5_index=val_img5[index:index+1,:,:,:]
    # val_img6_index=val_img6[index:index+1,:,:,:]
    val_img1_index = np.array(val_img1_index)
    val_img2_index = np.array(val_img2_index)
    val_img3_index = np.array(val_img3_index)
    val_img4_index = np.array(val_img4_index)
    val_img5_index = np.array(val_img5_index)
    # val_img6_index = np.array(val_img6_index)
    
    pred1 = model1.predict(val_img1_index)
    reset_keras()
    pred2 = model2.predict(val_img2_index)
    reset_keras()
    pred3 = model3.predict(val_img3_index)
    reset_keras()
    pred4 = model4.predict(val_img4_index)
    reset_keras()
    pred5 = model5.predict(val_img5_index)
    reset_keras()
    # pred6 = model6.predict(val_img6_index)
    # reset_keras()
    val_pred1_add.append(np.array(pred1[0,:,:,:]))
    val_pred2_add.append(np.array(pred2[0,:,:,:]))
    val_pred3_add.append(np.array(pred3[0,:,:,:]))
    val_pred4_add.append(np.array(pred4[0,:,:,:]))
    val_pred5_add.append(np.array(pred5[0,:,:,:]))
    # val_pred6_add.append(np.array(pred6[0,:,:,:]))

#先分類後回歸
# val_pred1_add = np.argmax(np.array(val_pred1_add), axis=3)[:,:,:]
# val_pred2_add = np.argmax(np.array(val_pred2_add), axis=3)[:,:,:]
# val_pred3_add = np.argmax(np.array(val_pred3_add), axis=3)[:,:,:]
# val_pred4_add = np.argmax(np.array(val_pred4_add), axis=3)[:,:,:]
# val_pred5_add = np.argmax(np.array(val_pred5_add), axis=3)[:,:,:]
# val_pred6_add = np.argmax(np.array(val_pred6_add), axis=3)[:,:,:]
# val_pred1_add = val_pred1_add.reshape((val_pred1_add.shape[0], val_pred1_add.shape[1], val_pred1_add.shape[2], 1))
# val_pred2_add = val_pred2_add.reshape((val_pred2_add.shape[0], val_pred2_add.shape[1], val_pred2_add.shape[2], 1))
# val_pred3_add = val_pred3_add.reshape((val_pred3_add.shape[0], val_pred3_add.shape[1], val_pred3_add.shape[2], 1))
# val_pred4_add = val_pred4_add.reshape((val_pred4_add.shape[0], val_pred4_add.shape[1], val_pred4_add.shape[2], 1))
# val_pred5_add = val_pred5_add.reshape((val_pred5_add.shape[0], val_pred5_add.shape[1], val_pred5_add.shape[2], 1))
# val_pred6_add = val_pred6_add.reshape((val_pred6_add.shape[0], val_pred6_add.shape[1], val_pred6_add.shape[2], 1))
...
# X_train = np.concatenate([train_pred1_add, train_pred2_add, train_pred3_add, train_pred4_add, train_pred5_add], axis=3).astype(float)
# X_val = np.concatenate([val_pred1_add, val_pred2_add, val_pred3_add, val_pred4_add, val_pred5_add], axis=3).astype(float)
# X_test = np.concatenate([pred1_add, pred2_add, pred3_add, pred4_add, pred5_add], axis=3).astype(float)
    
# X_train = np.concatenate([train_pred2_add, train_pred3_add, train_pred1_add, train_pred4_add], axis=3).astype(float)
# X_val = np.concatenate([val_pred2_add, val_pred3_add, val_pred1_add, val_pred4_add], axis=3).astype(float)
# X_test = np.concatenate([pred2_add, pred3_add, pred1_add, pred4v_add], axis=3).astype(float)

X_train = np.concatenate([train_pred1_add, train_pred4_add, train_pred5_add], axis=3).astype(float)
X_val = np.concatenate([val_pred1_add, val_pred4_add, val_pred5_add], axis=3).astype(float)
X_test = np.concatenate([pred1_add, pred4_add, pred5_add], axis=3).astype(float)

# X_train = np.concatenate([train_pred1_add, train_pred2_add], axis=3).astype(float)
# X_val = np.concatenate([val_pred1_add, val_pred2_add], axis=3).astype(float)
# X_test = np.concatenate([pred1_add, pred2_add], axis=3).astype(float)


from tensorflow.keras.utils import to_categorical
label_train = label_train.reshape((label_train.shape[0] * label_train.shape[1] * label_train.shape[2]))
label_train = to_categorical(label_train, 3)
label_train = label_train.reshape((236, 512, 512, 3)).astype(float)
label_val = label_val.reshape((label_val.shape[0] * label_val.shape[1] * label_val.shape[2]))
label_val = to_categorical(label_val, 3)
label_val = label_val.reshape((30, 512, 512, 3)).astype(float)
label = label.reshape((label.shape[0] * label.shape[1] * label.shape[2]))
label = to_categorical(label, 3)
label = label.reshape((33, 512, 512, 3)).astype(float)
...
from keras.layers import Conv2D, Dense, InputLayer, MaxPooling2D, Flatten  # Convolution Operation
...
es = EarlyStopping(monitor='val_iou_score', patience=20, mode='max', restore_best_weights=True)
#es = EarlyStopping(monitor='val_acc', patience=10, mode='max', restore_best_weights=True)
filepath = "ensemble_CNN.hdf5"
save_dir = os.path.join(os.getcwd(), './ensemble_models')
model_checkpoint=ModelCheckpoint(os.path.join(save_dir, filepath),monitor='val_iou_score',verbose=0, save_best_only=True, save_weights_only=False, mode = 'max')
#model_checkpoint=ModelCheckpoint(os.path.join(save_dir, filepath),monitor='val_acc',verbose=0, save_best_only=True, save_weights_only=False, mode = 'max')


model = Sequential()

# model.add(Dropout(0.8, input_shape = (512, 512, 6)))
...
model.add(Dense(256, activation='relu', input_shape=(512, 512, 9)))
...
model.compile(optimizer = tf.optimizers.Adam(0.0001), loss = total_loss, metrics = metrics)

Net = model.fit(X_train, label_train, 
                    batch_size = 5, 
                    verbose=1, 
                    epochs=100,
...
#顯示訓練與驗證的accuracy
f, ax = plt.subplots()
ax.plot([None] + Net.history['iou_score'], 'o-')
ax.plot([None] + Net.history['val_iou_score'], 'x-')
ax.legend(['IoU score', 'Val IoU score'], loc = 0)
ax.set_title('Training/Validation MIoU per epoch')
ax.set_xlabel('Epoch')
ax.set_ylabel('MIoU')
plt.savefig("./iou_score.png")
#顯示訓練與驗證的loss
f, ax = plt.subplots()
ax.plot([None] + Net.history['loss'], 'o-')
ax.plot([None] + Net.history['val_loss'], 'x-')
...
for file in range(X_test.shape[0]):
    test_image = []
    test_image.append(np.array(X_test[file,:,:,:]))
    test_image = np.array(test_image)
    predict_result = model.predict(test_image)
    predict_result = np.argmax(predict_result, axis=3)[0,:,:]
...
for SIZE_i in SIZE:
    ...
    ground_truth = []
    # 指定要查詢的路徑
    df = pd.read_excel('C:/Users/EN308/Desktop/Kai/2class_MODEL/ensemble/class.xls')  
...
incorrect_indices = np.where(ground_truth != predict_result)[0]
print("\nIncorrect Predictions:")
for idx in incorrect_indices:
     print(f"Image Filename: {allFileList[idx]}, Ground Truth: {ground_truth[idx]}, Predicted: {predict_result[idx]}")
