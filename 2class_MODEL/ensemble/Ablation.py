...
# train_img2=getTestDate("C:/Users/EN308/Desktop/Abdiel/2class_MODEL/yun_Bone_suppression_Lung_segmentation/train/image")
# test_imag2=getTestDate("C:/Users/EN308/Desktop/Abdiel/2class_MODEL/yun_Bone_suppression_Lung_segmentation/test_Noneresult_image")
...
train_img3=getTestDate("C:/Users/EN308/Desktop/Abdiel/2class_MODEL/yun_normal/train/image_CLAHE")
test_imag3=getTestDate("C:/Users/EN308/Desktop/Abdiel/2class_MODEL/yun_normal/test_CLAHEresult_image")
...
train_img4=getTestDate("C:/Users/EN308/Desktop/Abdiel/2class_MODEL/yun_Bone_suppression/train/image")
test_imag4=getTestDate("C:/Users/EN308/Desktop/Abdiel/2class_MODEL/yun_Bone_suppression/test_Noneresult_image")
...
X_train = np.concatenate([train_pred1_add, train_pred2_add, train_pred3_add, train_pred4_add], axis=3)
X_test = np.concatenate([pred1_add, pred2_add, pred3_add, pred4_add], axis=3)
...
#邏輯回歸
#logistic_regr =LogisticRegression(class_weight='balanced', verbose=2)
#logistic_regr =LogisticRegression(random_state=0, solver="newton-cg", multi_class="multinomial", verbose=2)

#SoftmaxRegression
#logistic_regr = SoftmaxRegression(eta=0.01, epochs=300, minibatches=1, print_progress=2)

#MLPClassifier
#logistic_regr = MLPClassifier(max_iter=200, activation='logistic', verbose=2)

#naive_bayes
logistic_regr = ComplementNB()

#SVM
#logistic_regr = SVC(verbose=1)

#KNN
#logistic_regr = KNeighborsClassifier(n_neighbors=5)
#logistic_regr = KNeighborsRegressor()

#Decision Tree
#logistic_regr = DecisionTreeClassifier(random_state=0)
#logistic_regr = DecisionTreeRegressor(random_state=0)


#Random Forest
#logistic_regr = RandomForestRegressor()

#gaussian_process
#logistic_regr = GaussianProcessClassifier(random_state=0, multi_class="one_vs_rest")

logistic_regr.fit(X_train, label_train)

# estimators = [
#      ('lr', LogisticRegression(class_weight='balanced', verbose=2)),
...
#儲存模型
pickle.dump(logistic_regr, open('./ensemble_models/NB_Ablation.pkl', 'wb'))
#logistic_regr_cost = logistic_regr.cost_

#載入模型
#logistic_regr = pickle.load(open('./1012DecisionTreeRegressor/DTR.pkl', 'rb'))
#plt.plot(range(len(logistic_regr.cost_)), logistic_regr.cost_)
#plt.xlabel('Iterations')
#plt.ylabel('Cost')
#plt.show()

# plot_decision_regions(X_train, label_train, clf=logistic_regr)
# plt.title('logistic Regression')
# plt.show()
#logistic_regr_n_iter = logistic_regr.n_iter_()
#print("Iteration times:", logistic_regr_n_iter)
print("train...OK")

# 測試集的預測
yhat=logistic_regr.predict(X_test)
#logis_predict_proba_ = logistic_regr.predict_proba(X_test)
