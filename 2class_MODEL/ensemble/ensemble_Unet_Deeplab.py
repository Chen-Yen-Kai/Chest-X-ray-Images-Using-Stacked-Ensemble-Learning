...
train_img1=getTestDate("C:/Users/EN308/Desktop/Abdiel/2class_MODEL/yun_normalLung_segmentation/train/image")
test_imag1=getTestDate("C:/Users/EN308/Desktop/Abdiel/2class_MODEL/yun_normalLung_segmentation/test_Noneresult_image")
...
train_img2=getTestDate("C:/Users/EN308/Desktop/Abdiel/2class_MODEL/yun_normal/train/image_CLAHE")
test_imag2=getTestDate("C:/Users/EN308/Desktop/Abdiel/2class_MODEL/yun_normal/test_CLAHEresult_image")
...
train_img4=getTestDate("C:/Users/EN308/Desktop/Abdiel/2class_MODEL/yun_normalLung_segmentation/train/image")
test_imag4=getTestDate("C:/Users/EN308/Desktop/Abdiel/2class_MODEL/yun_normalLung_segmentation/test_Noneresult_image")
...
train_img5=getTestDate("C:/Users/EN308/Desktop/Abdiel/2class_MODEL/yun_normal/train/image_CLAHE")
test_imag5=getTestDate("C:/Users/EN308/Desktop/Abdiel/2class_MODEL/yun_normal/test_CLAHEresult_image")
                    ...
                    for loss in range(len(loss_functions_str)):
                        ...
                        for rate in range(len(rate_functions)):
                            ...
                            if blackbone_functions[blackbone] == "none" :
                                ...
                                model = model =modelv3.Deeplabv3(input_shape = (512,512,3))
...
train_img6=getTestDate("C:/Users/EN308/Desktop/Abdiel/2class_MODEL/yun_Bone_suppression/train/image_CLAHE")
test_imag6=getTestDate("C:/Users/EN308/Desktop/Abdiel/2class_MODEL/yun_Bone_suppression/test_CLAHEresult_image")
...
train_img7=getTestDate("C:/Users/EN308/Desktop/Abdiel/2class_MODEL/yun_normal/train/image")
test_imag7=getTestDate("C:/Users/EN308/Desktop/Abdiel/2class_MODEL/yun_normal/test_Noneresult_image")
...
train_img8=getTestDate("C:/Users/EN308/Desktop/Abdiel/2class_MODEL/yun_Bone_suppression/train/image")
test_imag8=getTestDate("C:/Users/EN308/Desktop/Abdiel/2class_MODEL/yun_Bone_suppression/test_Noneresult_image")
...
train_img9=getTestDate("C:/Users/EN308/Desktop/Abdiel/2class_MODEL/yun_normalLung_segmentation/train/image_CLAHE")
test_imag9=getTestDate("C:/Users/EN308/Desktop/Abdiel/2class_MODEL/yun_normalLung_segmentation/test_CLAHEresult_image")
...
for index in range(109):
    ...
    train_img7_index=train_img4[index:index+1,:,:,:]
    train_img8_index=train_img5[index:index+1,:,:,:]
    train_img9_index=train_img6[index:index+1,:,:,:]
    ...
    train_img7_index = np.array(train_img4_index)
    train_img8_index = np.array(train_img5_index)
    train_img9_index = np.array(train_img6_index)
    ...
    reset_keras()
    pred7 = model7.predict(train_img7_index)
    reset_keras()
    pred8 = model8.predict(train_img8_index)
    reset_keras()
    pred9 = model9.predict(train_img9_index)
    reset_keras()
    ...
    train_pred7_add.append(np.array(pred7[0,:,:,:]))
    train_pred8_add.append(np.array(pred8[0,:,:,:]))
    train_pred9_add.append(np.array(pred9[0,:,:,:]))

#先分類後回歸
# train_pred1_max = np.argmax(np.array(train_pred1_add), axis=3)[:,:,:]
# train_pred2_max = np.argmax(np.array(train_pred2_add), axis=3)[:,:,:]
# train_pred3_max = np.argmax(np.array(train_pred3_add), axis=3)[:,:,:]
# train_pred4_max = np.argmax(np.array(train_pred4_add), axis=3)[:,:,:]
# train_pred5_max = np.argmax(np.array(train_pred5_add), axis=3)[:,:,:]

# train_pred1_max = train_pred1_max.reshape((train_pred1_max.shape[0] * train_pred1_max.shape[1] * train_pred1_max.shape[2]))
# train_pred2_max = train_pred2_max.reshape((train_pred2_max.shape[0] * train_pred2_max.shape[1] * train_pred2_max.shape[2]))
# train_pred3_max = train_pred3_max.reshape((train_pred3_max.shape[0] * train_pred3_max.shape[1] * train_pred3_max.shape[2]))
# train_pred4_max = train_pred4_max.reshape((train_pred4_max.shape[0] * train_pred4_max.shape[1] * train_pred4_max.shape[2]))
# train_pred5_max = train_pred5_max.reshape((train_pred5_max.shape[0] * train_pred5_max.shape[1] * train_pred5_max.shape[2]))
...
for index in range(21):   
    ...
    test_imag7_index=test_imag7[index:index+1,:,:,:]
    test_imag8_index=test_imag8[index:index+1,:,:,:]
    test_imag9_index=test_imag9[index:index+1,:,:,:]
    ...
    test_imag7_index = np.array(test_imag7_index)
    test_imag8_index = np.array(test_imag8_index)
    test_imag9_index = np.array(test_imag9_index)
    ...
    pred6 = model6.predict(test_imag6_index)
    reset_keras()
    pred7 = model7.predict(test_imag7_index)
    reset_keras()
    pred8 = model8.predict(test_imag8_index)
    reset_keras()
    pred9 = model9.predict(test_imag9_index)
    reset_keras()
    ...
    pred7_add.append(np.array(pred7[0,:,:,:]))
    pred8_add.append(np.array(pred8[0,:,:,:]))
    pred9_add.append(np.array(pred9[0,:,:,:]))

#先分類後回歸
# pred1_max = np.argmax(np.array(pred1_add), axis=3)[:,:,:]
# pred2_max = np.argmax(np.array(pred2_add), axis=3)[:,:,:]
# pred3_max = np.argmax(np.array(pred3_add), axis=3)[:,:,:]
# pred4_max = np.argmax(np.array(pred4_add), axis=3)[:,:,:]
# pred5_max = np.argmax(np.array(pred5_add), axis=3)[:,:,:]

# pred1_max = pred1_max.reshape((pred1_max.shape[0] * pred1_max.shape[1] * pred1_max.shape[2]))
# pred2_max = pred2_max.reshape((pred2_max.shape[0] * pred2_max.shape[1] * pred2_max.shape[2]))
# pred3_max = pred3_max.reshape((pred3_max.shape[0] * pred3_max.shape[1] * pred3_max.shape[2]))
# pred4_max = pred4_max.reshape((pred4_max.shape[0] * pred4_max.shape[1] * pred4_max.shape[2]))
# pred5_max = pred5_max.reshape((pred5_max.shape[0] * pred5_max.shape[1] * pred5_max.shape[2]))

#print("train_pred1_max_shape:", np.array(train_pred1_max).shape)

# corrected
#先分類後回歸
# X_train = np.vstack([train_pred1_max, train_pred2_max, train_pred3_max, train_pred4_max, train_pred5_max])
# X_train = np.transpose(X_train)
# X_test = np.vstack([pred1_max, pred2_max, pred3_max, pred4_max, pred5_max])
# X_test = np.transpose(X_test)

X_train1 = np.concatenate([train_pred1_add, train_pred2_add, train_pred3_add, train_pred4_add], axis=3)
X_test1 = np.concatenate([pred1_add, pred2_add, pred3_add, pred4_add], axis=3)
X_train2 = np.concatenate([train_pred5_add, train_pred6_add, train_pred7_add, train_pred8_add, train_pred9_add], axis=3)
X_test2 = np.concatenate([pred5_add, pred6_add, pred7_add, pred8_add, pred9_add], axis=3)
print("X_train_shape:", X_train1.shape)
print("X_test_shape:", X_test1.shape)
...
#測試單個模型
# train_pred1_add = np.array(train_pred1_add)
# X_train = train_pred1_add.reshape((train_pred1_add.shape[0] * train_pred1_add.shape[1] * train_pred1_add.shape[2], train_pred1_add.shape[3]))
...
from sklearn.ensemble import StackingClassifier, RandomForestClassifier, RandomForestRegressor, VotingRegressor, VotingClassifier
from sklearn.preprocessing import StandardScaler
# 建立模型 訓練訓練集資料

#邏輯回歸
#logistic_regr =LogisticRegression(class_weight='balanced', verbose=2, multi_class='ovr', tol=0.00001, C=0.01)
#logistic_regr =LogisticRegression(class_weight='balanced', verbose=2, multi_class='ovr')
#logistic_regr = LogisticRegression(class_weight='balanced', verbose=2, multi_class='multinomial')
#logistic_regr = LogisticRegression(class_weight={0:1, 1:50, 2:1}, verbose=2, multi_class='multinomial')
#print("lr complete")

#SoftmaxRegression
#logistic_regr = SoftmaxRegression(eta=0.01, epochs=300, minibatches=1, print_progress=2)
#logistic_regr = SoftmaxRegression(eta=0.01, epochs=100, minibatches=1, n_classes=3, print_progress=2)


logistic_regr.fit(X_train1, label_train)
#logistic_regr.fit(X_train[ :14286848, : ], label_train[ :14286848])
#softmax_regr.fit(X_train[ :14286848, : ], label_train[ :14286848])
#print("vr fitting completed")

#儲存模型
#pickle.dump(logistic_regr, open('./ensemble_models/SMR_Deeplab.pkl', 'wb'))
#pickle.dump(softmax_regr, open('./ensemble_models/SMR_half.pkl', 'wb'))
#logistic_regr_cost = logistic_regr.cost_


#載入模型
# logistic_regr = pickle.load(open('./ensemble_models/SMR_Unet.pkl', 'rb'))

print("train...OK")


# 測試集的預測
yhat=logistic_regr.predict(X_test1)

print("yhat_shape:", yhat.shape)
target_names = ['class 0', 'class 1', 'class 2']
#print(classification_report(label, yhat, target_names=target_names))
ensemble_prediction=yhat.reshape((21,512,512))
...
for SIZE_i in SIZE:
    ...
    allFileList = os.listdir(yourPath)
    result_index = 0
    test_smear = np.zeros((len(allFileList), 4))
    for file in allFileList:
      if os.path.isdir(os.path.join(yourPath,file)):
        print("I'm a directory: " + file)
      elif os.path.isfile(yourPath+file):
