...
loss_functions = [focal_tversky] 

# =['categorical_crossentropy', 'focal_tversky', 'total_loss', 'hybrid_loss']  
...
for colder_index in range(len(folder_functions)):
    ...
    xlsx_file='model_'+training_data_path+'.xlsx'
    ...
    wb=openpyxl.load_workbook(r''+'model_'+folder_functions[colder_index]+'.xlsx')
    # 新建一個sheet的物件
                ...
                for loss in range(len(loss_functions_str)):
                    ...
                    for rate in range(len(rate_functions)):
                        ...
                        #net_str='U_Net','att_unet',"unetplusplus","att_unetplusplus"
                            ...
                            elif net_str[net] == "Deeplabv3plus" :
...
wb.save(r''+'model_'+folder_functions[colder_index]+'.xlsx')
